...
.PHONY: lint-py build image build-panic image-panic build-pf image-pf build-idt image-idt \
       ...
       test-security-baseline test-runtime-maturity test-mm-foundation-v1 test-sched-preempt-v1 test-dynamic-tasks-v1 test-exec-v1 test-vfs-v1 test-tcp-v1 test-netcfg-v1 test-console-v1 test-coreutils-v1 test-pipes-v1 test-concurrent-exec-v1 test-fork-v1 test-mmap-v1 test-clock-v1 test-rng-v1 test-sandbox-v1 test-devfs-v1 test-sysinfo-v1 test-power-v1 test-libc-v1 test-wx-v1 test-signals-v1 test-users-v1 test-smp-v1 test-process-scheduler-v2 test-compat-v2 test-real-compat-runtime-v1 test-network-stack-v1 test-network-stack-v2 \
...
COREUTILS_ELFS = $(OUT)/app-echo.elf $(OUT)/app-cat.elf $(OUT)/app-ls.elf $(OUT)/app-ps.elf $(OUT)/app-wc.elf $(OUT)/app-nxprobe.elf $(OUT)/app-sigprobe.elf $(OUT)/app-fsperm.elf $(OUT)/app-asprobe.elf $(OUT)/app-forkprobe.elf $(OUT)/app-vmprobe.elf $(OUT)/app-timeprobe.elf $(OUT)/app-rngprobe.elf $(OUT)/app-sandboxprobe.elf $(OUT)/app-devprobe.elf $(OUT)/app-sysinfoprobe.elf
...
test-sched-preempt-v1: image-go
	$(PYTHON) -m pytest tests/sched/test_preempt_default_lane_v1.py -v --junitxml=$(OUT)/pytest-sched-preempt-v1.xml
...
test-netcfg-v1: image-go
	$(PYTHON) -m pytest tests/runtime/test_netcfg_runtime_v1.py -v --junitxml=$(OUT)/pytest-netcfg-v1.xml

test-libc-v1: image-go
	$(PYTHON) -m pytest tests/runtime/test_libc_runtime_v1.py -v --junitxml=$(OUT)/pytest-libc-v1.xml

test-wx-v1: image-go
	$(PYTHON) -m pytest tests/runtime/test_wx_runtime_v1.py -v --junitxml=$(OUT)/pytest-wx-v1.xml

test-signals-v1: image-go
	$(PYTHON) -m pytest tests/runtime/test_signals_runtime_v1.py -v --junitxml=$(OUT)/pytest-signals-v1.xml

test-users-v1: image-go
	$(PYTHON) -m pytest tests/runtime/test_users_runtime_v1.py -v --junitxml=$(OUT)/pytest-users-v1.xml
...
test-coreutils-v1: image-go
	$(PYTHON) -m pytest tests/runtime/test_coreutils_runtime_v1.py -v --junitxml=$(OUT)/pytest-coreutils-v1.xml
...
test-reliable-isolated-runtime-c5: image-go
	$(PYTHON) -m pytest tests/runtime/test_reliable_isolated_runtime_c5.py tests/runtime/test_c5_status_docs.py -v --junitxml=$(OUT)/pytest-reliable-isolated-runtime-c5.xml
...
test-hw-matrix-v4: image-blk image-blk-badlen image-blk-badptr image-net
	$(PYTHON) tools/run_hw_matrix_v4.py --out $(OUT)/hw-matrix-v4.json
	$(MAKE) test-hw-baremetal-promotion-v1
	$(PYTHON) -m pytest tests/hw/test_hw_matrix_docs_v4.py tests/hw/test_hw_matrix_v4.py tests/hw/test_driver_lifecycle_v4.py tests/hw/test_baremetal_promotion_v1.py tests/hw/test_hw_negative_paths_v4.py tests/hw/test_hw_gate_v4.py -v --junitxml=$(OUT)/pytest-hw-matrix-v4.xml
...
test-ecosystem-scale-v1:
	...
	$(PYTHON) -m pytest tests/pkg/test_ecosystem_scale_docs_v1.py tests/pkg/test_app_catalog_sim_v1.py tests/pkg/test_pkg_install_success_rate_v1.py tests/pkg/test_catalog_reproducibility_v1.py tests/pkg/test_distribution_workflow_v1.py tests/pkg/test_ecosystem_scale_gate_v1.py -v --junitxml=$(OUT)/pytest-ecosystem-scale-v1.xml
...
test-isolation-baseline-v1:
	...
	$(PYTHON) -m pytest tests/security/test_isolation_docs_v1.py tests/security/test_namespace_baseline_v1.py tests/security/test_cgroup_baseline_v1.py tests/security/test_isolation_escape_negative_v1.py tests/security/test_isolation_gate_v1.py -v --junitxml=$(OUT)/pytest-isolation-baseline-v1.xml
...
test-baremetal-io-baseline-v1:
	...
	$(PYTHON) -m pytest tests/hw/test_baremetal_io_profile_v1.py tests/hw/test_usb_input_removable_docs_v1.py tests/hw/test_e1000e_baseline_v1.py tests/hw/test_rtl8169_baseline_v1.py tests/hw/test_xhci_usb_hid_v1.py tests/hw/test_usb_storage_v1.py tests/hw/test_baremetal_io_recovery_v1.py tests/desktop/test_usb_input_focus_delivery_v1.py tests/hw/test_baremetal_io_gate_v1.py -v --junitxml=$(OUT)/pytest-baremetal-io-v1.xml

test-usb-input-removable-v1:
	$(PYTHON) tools/run_baremetal_io_baseline_v1.py --out $(OUT)/baremetal-io-v1.json
...
test-input-seat-v1:
	...
	$(SUBMAKE) test-hid-event-path-v1
	$(PYTHON) -m pytest tests/desktop/test_input_seat_docs_v1.py tests/desktop/test_keyboard_event_delivery_v1.py tests/desktop/test_pointer_motion_buttons_v1.py tests/desktop/test_focus_routing_v1.py tests/desktop/test_seat_hotplug_v1.py tests/desktop/test_input_seat_gate_v1.py -v --junitxml=$(OUT)/pytest-input-seat-v1.xml

test-hid-event-path-v1:
	$(PYTHON) tools/run_input_seat_runtime_v1.py --out $(OUT)/input-seat-v1.json
	$(PYTHON) tools/run_hid_event_path_v1.py --out $(OUT)/hid-event-path-v1.json
	$(PYTHON) -m pytest tests/desktop/test_input_seat_docs_v1.py tests/desktop/test_keyboard_event_delivery_v1.py tests/desktop/test_pointer_motion_buttons_v1.py tests/desktop/test_focus_routing_v1.py tests/desktop/test_seat_hotplug_v1.py tests/desktop/test_hid_event_path_gate_v1.py -v --junitxml=$(OUT)/pytest-hid-event-path-v1.xml
...
test-window-system-v1:
	...
	$(PYTHON) -m pytest tests/desktop/test_window_system_docs_v1.py tests/desktop/test_surface_lifecycle_v1.py tests/desktop/test_window_zorder_v1.py tests/desktop/test_compositor_damage_regions_v1.py tests/desktop/test_window_resize_move_v1.py tests/desktop/test_window_system_gate_v1.py -v --junitxml=$(OUT)/pytest-window-system-v1.xml

test-compositor-damage-v1:
	$(PYTHON) tools/run_window_system_runtime_v1.py --out $(OUT)/window-system-v1.json
	$(PYTHON) tools/run_compositor_damage_v1.py --out $(OUT)/compositor-damage-v1.json
	$(PYTHON) -m pytest tests/desktop/test_window_system_docs_v1.py tests/desktop/test_surface_lifecycle_v1.py tests/desktop/test_window_zorder_v1.py tests/desktop/test_compositor_damage_regions_v1.py tests/desktop/test_window_resize_move_v1.py tests/desktop/test_compositor_damage_gate_v1.py -v --junitxml=$(OUT)/pytest-compositor-damage-v1.xml

test-gui-runtime-v1:
	$(PYTHON) tools/run_gui_runtime_v1.py --out $(OUT)/gui-runtime-v1.json
	$(SUBMAKE) test-toolkit-compat-v1
	$(PYTHON) -m pytest tests/desktop/test_gui_runtime_docs_v1.py tests/desktop/test_gui_app_launch_render_v1.py tests/desktop/test_font_text_rendering_v1.py tests/desktop/test_toolkit_event_loop_v1.py tests/desktop/test_gui_runtime_negative_v1.py tests/desktop/test_gui_runtime_gate_v1.py -v --junitxml=$(OUT)/pytest-gui-runtime-v1.xml

test-toolkit-compat-v1:
	$(PYTHON) tools/run_gui_runtime_v1.py --out $(OUT)/gui-runtime-v1.json
	$(PYTHON) tools/run_toolkit_compat_v1.py --out $(OUT)/toolkit-compat-v1.json
	$(PYTHON) -m pytest tests/desktop/test_gui_runtime_docs_v1.py tests/desktop/test_gui_app_launch_render_v1.py tests/desktop/test_font_text_rendering_v1.py tests/desktop/test_toolkit_event_loop_v1.py tests/desktop/test_gui_runtime_negative_v1.py tests/desktop/test_toolkit_compat_gate_v1.py -v --junitxml=$(OUT)/pytest-toolkit-compat-v1.xml

test-desktop-shell-v1:
	$(PYTHON) tools/run_desktop_shell_workflows_v1.py --out $(OUT)/desktop-shell-v1.json
	$(SUBMAKE) test-desktop-workflows-v1
	$(PYTHON) -m pytest tests/desktop/test_desktop_shell_docs_v1.py tests/desktop/test_shell_launcher_workflow_v1.py tests/desktop/test_file_open_save_workflow_v1.py tests/desktop/test_settings_workflow_v1.py tests/build/test_graphical_installer_smoke_v1.py tests/desktop/test_desktop_shell_gate_v1.py -v --junitxml=$(OUT)/pytest-desktop-shell-v1.xml

test-desktop-workflows-v1:
	$(PYTHON) tools/run_desktop_shell_workflows_v1.py --out $(OUT)/desktop-shell-v1.json
...
test-hw-matrix-v7:
	...
	$(PYTHON) -m pytest tests/hw/test_nvme_ahci_docs_v1.py tests/storage/test_block_flush_contract_v1.py tests/hw/test_nvme_identify_v1.py tests/hw/test_nvme_io_queue_v1.py tests/hw/test_ahci_rw_v1.py tests/storage/test_nvme_fsync_integration_v1.py tests/hw/test_native_storage_negative_v1.py tests/hw/test_hw_gate_v7.py -v --junitxml=$(OUT)/pytest-hw-matrix-v7.xml
...
test-real-ecosystem-desktop-v2:
	...
	$(PYTHON) -m pytest tests/desktop/test_desktop_docs_v2.py tests/pkg/test_ecosystem_scale_docs_v2.py tests/desktop/test_gui_runtime_qualification_v2.py tests/desktop/test_real_desktop_gate_v2.py -v --junitxml=$(OUT)/pytest-real-ecosystem-desktop-v2.xml
