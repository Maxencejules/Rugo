...
- IDs `48..63` are reserved for additive v3.2 expansion under the same
  ...
  op 3 = poll, op 4 = ICMP echo self-test → 1 ok / 0 fail; contract in
  ...
  entry); contract in `docs/runtime/sysinfo_v1.md`,
  `docs/runtime/dmesg_v1.md`, `docs/runtime/partitions_v1.md`).
