...
def classify_runtime_line(line: str) -> Dict[str, object]:
    ...
    elif prefix in {"TIMESVC", "DIAGSVC", "GOINIT", "GOSVCM", "GOSH"}:
        event["service"] = component
    elif prefix in {"STORC4", "NETC4", "ISOC5", "SOAKC5"}:
        event["service"] = component
    elif prefix == "RUGO":
...
def fixture_boot_lines() -> List[List[Dict[str, object]]]:
    boot1 = [
        ...
        (472, "DIAGSVC: ready"),
        (506, "SVC: shell declared"),
        (531, "SVC: shell starting"),
        (562, "GOSVCM: class shell best-effort"),
        (596, "GOSH: start"),
        (622, "SVC: shell running"),
        (659, "GOSH: lookup ok"),
        (702, "TIMESVC: req ok"),
        (730, "TIMESVC: time ok"),
        (761, "GOSH: reply ok"),
        (798, "DIAGSVC: snapshot"),
        (822, "PROC: timesvc s=1 r=0 f=0 x=0 tick=41"),
        (837, "PROC: diagsvc s=1 r=0 f=0 x=0 tick=42"),
        (853, "PROC: shell s=3 r=2 f=2 x=2 tick=43"),
        (882, "TASK: timesvc tid=1 parent=0 cls=critical st=blocked run=16 y=0 blk=2 tx=6 rx=3 ep=1 dom=1 cap=0 fd=0 sock=0"),
        (904, "TASK: diagsvc tid=2 parent=0 cls=best-effort st=running run=11 y=1 blk=1 tx=3 rx=5 ep=1 dom=2 cap=0 fd=0 sock=0"),
        (930, "TASK: shell tid=3 parent=0 cls=best-effort st=blocked run=18 y=4 blk=3 tx=4 rx=4 ep=1 dom=3 cap=3 fd=1 sock=3"),
        (955, "GOSH: diag ok"),
        (989, "STORC4: journal staged"),
        (1018, "NETC4: ifcfg ok"),
        (1046, "NETC4: route ok"),
        (1077, "NETC4: listen ok"),
        (1108, "NETC4: connect ok"),
        (1136, "NETC4: accept ok"),
        (1167, "NETC4: recv ok"),
        (1195, "NETC4: reply ok"),
        (1226, "ISOC5: domain ok"),
        (1254, "ISOC5: quota ok"),
        (1288, "DIAGSVC: snapshot"),
        (1312, "PROC: timesvc s=1 r=0 f=0 x=0 tick=44"),
        (1327, "PROC: diagsvc s=1 r=0 f=0 x=0 tick=45"),
        (1343, "PROC: shell s=3 r=2 f=2 x=2 tick=46"),
        (1372, "TASK: timesvc tid=1 parent=0 cls=critical st=blocked run=20 y=0 blk=2 tx=8 rx=4 ep=1 dom=1 cap=0 fd=0 sock=0"),
        (1394, "TASK: diagsvc tid=2 parent=0 cls=best-effort st=running run=14 y=1 blk=1 tx=4 rx=7 ep=1 dom=2 cap=0 fd=0 sock=0"),
        (1420, "TASK: shell tid=3 parent=0 cls=best-effort st=blocked run=22 y=6 blk=4 tx=5 rx=5 ep=1 dom=3 cap=3 fd=1 sock=3"),
        (1448, "ISOC5: observe ok"),
        (1483, "SOAKC5: mixed ok"),
        (1515, "GOSVCM: stop diagsvc"),
        (1542, "SVC: diagsvc stopping"),
        (1568, "DIAGSVC: stop"),
        (1597, "SVC: diagsvc stopped"),
        (1628, "GOSVCM: reap diagsvc"),
        (1660, "ISOC5: cleanup ok"),
        (1687, "GOINIT: ready"),
        (1715, "RUGO: halt ok"),
    ]
    boot2 = [
        ...
        (423, "DIAGSVC: ready"),
        (447, "SVC: shell declared"),
        (473, "SVC: shell starting"),
        (499, "GOSVCM: class shell best-effort"),
        (525, "GOSH: start"),
        (553, "SVC: shell running"),
        (587, "GOSH: lookup ok"),
        (616, "STORC4: state ok"),
        (648, "BLK: flush ordered"),
        (678, "STORC4: fsync ok"),
        (706, "TIMESVC: req ok"),
        (734, "TIMESVC: time ok"),
        (761, "GOSH: reply ok"),
        (792, "DIAGSVC: snapshot"),
        (814, "PROC: timesvc s=1 r=0 f=0 x=0 tick=47"),
        (828, "PROC: diagsvc s=1 r=0 f=0 x=0 tick=48"),
        (843, "PROC: shell s=3 r=2 f=2 x=2 tick=49"),
        (870, "TASK: timesvc tid=1 parent=0 cls=critical st=blocked run=23 y=0 blk=2 tx=10 rx=5 ep=1 dom=1 cap=0 fd=0 sock=0"),
        (891, "TASK: diagsvc tid=2 parent=0 cls=best-effort st=running run=16 y=1 blk=1 tx=5 rx=9 ep=1 dom=2 cap=0 fd=0 sock=0"),
        (916, "TASK: shell tid=3 parent=0 cls=best-effort st=blocked run=26 y=8 blk=5 tx=6 rx=6 ep=1 dom=3 cap=3 fd=1 sock=3"),
        (944, "GOSH: diag ok"),
        (973, "NETC4: ifcfg ok"),
        (1000, "NETC4: route ok"),
        (1026, "NETC4: listen ok"),
        (1055, "NETC4: connect ok"),
        (1082, "NETC4: accept ok"),
        (1111, "NETC4: recv ok"),
        (1138, "NETC4: reply ok"),
        (1166, "ISOC5: domain ok"),
        (1191, "ISOC5: quota ok"),
        (1221, "DIAGSVC: snapshot"),
        (1244, "PROC: timesvc s=1 r=0 f=0 x=0 tick=50"),
        (1258, "PROC: diagsvc s=1 r=0 f=0 x=0 tick=51"),
        (1272, "PROC: shell s=3 r=2 f=2 x=2 tick=52"),
        (1299, "TASK: timesvc tid=1 parent=0 cls=critical st=blocked run=27 y=0 blk=2 tx=12 rx=6 ep=1 dom=1 cap=0 fd=0 sock=0"),
        (1320, "TASK: diagsvc tid=2 parent=0 cls=best-effort st=running run=19 y=1 blk=1 tx=6 rx=11 ep=1 dom=2 cap=0 fd=0 sock=0"),
        (1346, "TASK: shell tid=3 parent=0 cls=best-effort st=blocked run=30 y=10 blk=6 tx=7 rx=7 ep=1 dom=3 cap=3 fd=1 sock=3"),
        (1376, "ISOC5: observe ok"),
        (1406, "SOAKC5: mixed ok"),
        (1432, "GOSVCM: stop diagsvc"),
        (1457, "SVC: diagsvc stopping"),
        (1481, "DIAGSVC: stop"),
        (1507, "SVC: diagsvc stopped"),
        (1536, "GOSVCM: reap diagsvc"),
        (1562, "ISOC5: cleanup ok"),
        (1586, "GOINIT: ready"),
        (1610, "RUGO: halt ok"),
    ]
    return [
