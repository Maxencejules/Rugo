...
| M45 | Modern Virtual Platform Parity v1 | n/a | — | Planned: matrix v6 for modern VirtIO storage/network/CSI/GPU parity plus display-device bridge evidence, roadmap in `docs/M45_M47_HARDWARE_EXPANSION_ROADMAP.md`, backlog in `docs/M45_EXECUTION_BACKLOG.md`. |
| M46 | Bare-Metal I/O Baseline v1 | n/a | — | Planned: common wired-NIC, USB input, and removable-media qualification baseline with Tier 2 evidence targets, roadmap in `docs/M45_M47_HARDWARE_EXPANSION_ROADMAP.md`, backlog in `docs/M46_EXECUTION_BACKLOG.md`. |
| M47 | Hardware Claim Promotion Program v1 | n/a | — | Planned: auditable support-tier and promotion policy for claimable hardware classes, roadmap in `docs/M45_M47_HARDWARE_EXPANSION_ROADMAP.md`, backlog in `docs/M47_EXECUTION_BACKLOG.md`. |
