...
def _fat16_volume_bigfile():
    ...
    # FAT: media byte + reserved, then the chain 2 -> 3 -> EOC.
    ...
    # Root directory: BIG.TXT at first cluster 2, size 600.
    ...
    # Data area: cluster 2 = bytes[0:512], cluster 3 = bytes[512:600].
