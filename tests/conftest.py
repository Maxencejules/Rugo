...
APP_REGION_APPS = ["base-shell", "echo", "cat", "ls", "ps", "wc", "hello", "nxprobe", "sigprobe", "fsperm", "asprobe", "forkprobe", "vmprobe", "timeprobe", "rngprobe", "sandboxprobe", "devprobe", "sysinfoprobe", "futexprobe", "lseekprobe", "sleepprobe", "gfxprobe", "waitprobe", "timerfdprobe", "dmesgprobe"]
